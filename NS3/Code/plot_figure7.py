...
def read_trace(filename):
    """Read a two-column tab-separated (time, value) ns-3 trace file."""
    times, values = [], []
...
# ------------------------------------------------------------------
# Load RTT trace (seconds) and convert to milliseconds
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Plot — match Figure 7 style
# ------------------------------------------------------------------
fig, ax = plt.subplots(figsize=(8, 5))

# Single solid black line for RTT
ax.plot(rtt_t, rtt_ms,
        color='black', linewidth=0.9, label="BR-TCP RTT")

# ------------------------------------------------------------------
# Axes — match paper Figure 7
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Parameter annotation box (bottom-right, as in Figure 7)
# ------------------------------------------------------------------
textstr = (
    "Bandwidth = 40 [Mbps]\n"
